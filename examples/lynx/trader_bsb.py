...
# 选择策略
from czsc.strategies import trader_strategy_bsb as strategy
...
bars = dc.pro_bar_minutes('000001.SH', "20150101", "20221001", freq=freq_cn2ts[base_freq], asset="E", adj="hfq")

# 设置回放快照文件保存目录
res_path = r"D:\ts_data\replay_trader_bsb"
