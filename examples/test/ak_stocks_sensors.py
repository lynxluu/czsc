...
# 关闭掉 pandas 的 copywarning 会让执行速度更快
...
if __name__ == '__main__':
    ...
    sdt = "20180101"
    edt = "20220829"
    dc = TsDataCache(data_path, sdt, edt, site='ak')
    ...
    print("Debug msg @ak_stocks_sensors.py Line 67", row)
    ...
    # print("Debug msg @ak_stocks_sensors.py Line 70", row)
